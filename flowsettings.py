...
KH_PACKAGE_NAME = "rag_app"


# APP NAME -----------------------------------------
KH_APP_NAME = "RAGbilitacion Profesional"
#---------------------------------------------------
...
# KH_ENABLE_FIRST_SETUP = True // FOR NON-dev USERS
KH_ENABLE_FIRST_SETUP = False
KH_DEMO_MODE = config("KH_DEMO_MODE", default=False, cast=bool)

# App can be ran from anywhere and it's not trivial to decide where to store app data.
# So let's use the same directory as the flowsetting.py file.
KH_APP_DATA_DIR = this_dir / "rag_app_data"
...
KH_DOCSTORE = {
    # "__type__": "DocChatUI.storages.ElasticsearchDocumentStore",
    # "__type__": "DocChatUI.storages.SimpleFileDocumentStore",
    "__type__": "DocChatUI.storages.LanceDBDocumentStore",
    "path": str(KH_USER_DATA_DIR / "docstore"),
}
KH_VECTORSTORE = {
    # "__type__": "DocChatUI.storages.LanceDBVectorStore",
    "__type__": "DocChatUI.storages.ChromaVectorStore",
    # "__type__": "DocChatUI.storages.MilvusVectorStore",
    # "__type__": "DocChatUI.storages.QdrantVectorStore",
...
if config("AZURE_OPENAI_API_KEY", default="") and config(
    ...
    if config("AZURE_OPENAI_CHAT_DEPLOYMENT", default=""):
        KH_LLMS["azure"] = {
            "spec": {
                "__type__": "DocChatUI.llms.AzureChatOpenAI",
                "temperature": 0,
    ...
    if config("AZURE_OPENAI_EMBEDDINGS_DEPLOYMENT", default=""):
        KH_EMBEDDINGS["azure"] = {
            "spec": {
                "__type__": "DocChatUI.embeddings.AzureOpenAIEmbeddings",
                "azure_endpoint": config("AZURE_OPENAI_ENDPOINT", default=""),
                "api_key": config("AZURE_OPENAI_API_KEY", default=""),
                "api_version": config("OPENAI_API_VERSION", default="")
                or "2024-02-15-preview",
...
if config("OPENAI_API_KEY", default=""):
    KH_LLMS["openai"] = {
        "spec": {
            "__type__": "DocChatUI.llms.ChatOpenAI",
            "temperature": 0,
    ...
    KH_EMBEDDINGS["openai"] = {
        "spec": {
            "__type__": "DocChatUI.embeddings.OpenAIEmbeddings",
...
if config("LOCAL_MODEL", default=""):
    ...
    KH_EMBEDDINGS["fast_embed"] = {
        "spec": {
            "__type__": "DocChatUI.embeddings.FastEmbedEmbeddings",
...
KH_LLMS["claude"] = {
    "spec": {
        "__type__": "DocChatUI.llms.chats.LCAnthropicChat",
...
KH_LLMS["gemini"] = {
    "spec": {
        "__type__": "DocChatUI.llms.chats.LCGeminiChat",
...
KH_LLMS["cohere"] = {
    "spec": {
        "__type__": "DocChatUI.llms.chats.LCCohereChat",
...
KH_EMBEDDINGS["cohere"] = {
    "spec": {
        "__type__": "DocChatUI.embeddings.LCCohereEmbeddings",
...
#     "spec": {
#         "__type__": "DocChatUI.embeddings.LCHuggingFaceEmbeddings",
...
KH_RERANKINGS["cohere"] = {
    "spec": {
        "__type__": "DocChatUI.rerankings.CohereReranking",
...
KH_REASONINGS = [
    "DocProcessing.reasoning.simple.FullQAPipeline",
    "DocProcessing.reasoning.simple.FullDecomposeQAPipeline",
    "DocProcessing.reasoning.react.ReactAgentPipeline",
    "DocProcessing.reasoning.rewoo.RewooAgentPipeline",
]
...
SETTINGS_REASONING = {
    ...
    "lang": {
        "name": "Language",
        "value": "es",
        "choices": [("English", "en"), ("Japanese", "ja"), ("Vietnamese", "vi"), ("Spanish", "es")],
        "component": "dropdown",
    },
    "max_context_length": {
...
KH_INDEX_TYPES = [
    "DocProcessing.index.file.FileIndex",
    "DocProcessing.index.file.graph.GraphRAGIndex",
]
KH_INDICES = [
    {
        "name": "File",
        ...
        "index_type": "DocProcessing.index.file.FileIndex",
    },
    {
        "name": "GraphRAG",
        "config": {
        ...
        "index_type": "DocProcessing.index.file.graph.GraphRAGIndex",
    },
]
