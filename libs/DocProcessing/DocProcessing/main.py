...
from DocProcessing.app import BaseApp
from DocProcessing.pages.chat import ChatPage
from DocProcessing.pages.help import HelpPage
from DocProcessing.pages.resources import ResourcesTab
from DocProcessing.pages.settings import SettingsPage
from DocProcessing.pages.setup import SetupPage
...
class App(BaseApp):
    ...
    def ui(self):
        ...
        with gr.Tabs() as self.tabs:
            if self.f_user_management:
                from DocProcessing.pages.login import LoginPage

                with gr.Tab(
                    "Bienvenido", elem_id="login-tab", id="login-tab"
    ...
    def on_subscribe_public_events(self):
        if self.f_user_management:
            from DocProcessing.db.engine import engine
            from DocProcessing.db.models import User
