...
import gradio as gr
import pluggy
from DocProcessing import extension_protocol
from DocProcessing.assets import PDFJS_PREBUILT_DIR, DocChatUITheme
from DocProcessing.components import reasonings
from DocProcessing.exceptions import HookAlreadyDeclared, HookNotDeclared
from DocProcessing.index import IndexManager
from DocProcessing.settings import BaseSettingGroup, SettingGroup, SettingReasoningGroup
...
class BaseApp:
    ...
    def register_extensions(self):
        ...
        self.exman = pluggy.PluginManager("DocProcessing")
        self.exman.add_hookspecs(extension_protocol)
        self.exman.load_setuptools_entrypoints("DocProcessing")

        # retrieve and register extension declarations
        extension_declarations = self.exman.hook.DocProcessing_declare_extensions()
...
class BasePage:
    """The logic of the DocChatUI app"""
