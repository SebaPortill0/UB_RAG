...
from DocProcessing.db.models import Conversation, engine
from DocProcessing.index.file.ui import File
from DocProcessing.reasoning.prompt_optimization.suggest_conversation_name import (
    SuggestConvNamePipeline,
)
from DocProcessing.reasoning.prompt_optimization.suggest_followup_chat import (
...
from DocChatUI.base import Document
from DocChatUI.indices.ingests.files import KH_DEFAULT_FILE_EXTRACTORS
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1, elem_id="conv-settings-panel") as self.conv_column:
                ...
                if len(self._app.index_manager.indices) > 0:
                    with gr.Accordion(label="Carga Rápida") as _:
            ...
            with gr.Column(scale=6, elem_id="chat-area"):
                ...
                with gr.Row():
                    with gr.Accordion(label="Configuración del Chat", open=False):
                        # a quick switch for reasoning type option
                        with gr.Row():
                            gr.HTML("Método de Razonamiento")
                            gr.HTML("Modelo")
            ...
            with gr.Column(
                ...
                with gr.Accordion(label="Panel de información", open=True):
