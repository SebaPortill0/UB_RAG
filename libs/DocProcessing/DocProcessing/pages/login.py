...
from DocProcessing.db.models import User, engine
...
class LoginPage(BasePage):
    ...
    def on_building_ui(self):
        gr.Markdown(f"# Bienvenido a {self._app.app_name}!")
        self.usn = gr.Textbox(label="Nombre de usuario", visible=False)
        self.pwd = gr.Textbox(label="Contraseña", type="password", visible=False)
        self.btn_login = gr.Button("Iniciar Sesión", visible=False)
    ...
    def login(self, usn, pwd):
        ...
        with Session(engine) as session:
            ...
            gr.Warning("Nombre de usuario o contraseña inválidos.")
            return None, usn, pwd
